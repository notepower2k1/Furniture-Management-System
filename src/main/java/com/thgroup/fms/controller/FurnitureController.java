...
public class FurnitureController {
	...
	public String saveFurniture(@Valid @ModelAttribute("furniture") Furniture furniture,
	...
	public String AddFurniture(@Valid @ModelAttribute("furniture") Furniture furniture,
			BindingResult bindingResult,
			@RequestParam("file") MultipartFile file,
			@RequestParam("subfile") MultipartFile[] subfile, 
			RedirectAttributes redirectAttrs , @Param("img") String img ,@Param("imgs") String[] imgs){
