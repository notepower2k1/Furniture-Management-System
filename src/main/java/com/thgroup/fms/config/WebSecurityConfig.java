package com.thgroup.fms.config;
	...
	public class AdminSecurityConfig extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {
	        ...
	        .authorizeRequests()
	    		...
	    		.antMatchers("/admin", "/admin/detail-*/**").hasAnyRole("ADMIN", "EDITOR", "VISITOR")
	    		.antMatchers("/admin/create-*", "/admin/save-*", 
	    				"/admin/update-*/**").hasAnyRole("ADMIN", "EDITOR")
	            .antMatchers("/admin/delete-*/**", "/admin/update-employee/**").hasRole("ADMIN")
	            .and()
	        .formLogin()
