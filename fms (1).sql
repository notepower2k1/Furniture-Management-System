...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 19, 2022 at 05:30 PM
...
INSERT INTO `dondathang` (`iddon_hang`, `madh`, `ngay_lap`, `tinh_trang`, `dia_chi_nhan_hang`, `ghi_chu`, `id_tai_khoan`) VALUES
(2, 'DH001', '2022-03-26', b'0', 'test', 'test', 1),
(3, 'DH002', '2022-04-26', b'1', 'test', 'nothing', 2),
(4, 'DH003', '2022-05-11', b'1', '31/5 Võ Thị Sáu', 'Ship đến tận nhà cho tôi', 1),
(5, 'DH004', '2022-05-11', b'0', '31/5 Võ Thị Sáu', 'Nothing here', 1),
(6, 'DH005', '2022-05-12', b'0', '31/5 Võ Thị', 'Nothing', 2),
(8, 'DH006', '2022-05-19', b'0', 'test123', '', 1),
(10, 'DH007', '2022-05-19', b'0', 'test 123', 'tét', 1);
...
(2, '$2a$10$3gf2x/KYLW78rhZlp0mFf.PsggQni8gBzhKOoBG1pUP6y/favwAOe', 'thachnv1234', NULL),
...
ALTER TABLE `dondathang`
  ...
  ADD KEY `FKcb0tfvqyodibufohx97249ixt` (`id_tai_khoan`);
...
--
ALTER TABLE `dondathang`
  MODIFY `iddon_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `dondathang`
  ADD CONSTRAINT `FKcb0tfvqyodibufohx97249ixt` FOREIGN KEY (`id_tai_khoan`) REFERENCES `taikhoan` (`idtai_khoan`);
